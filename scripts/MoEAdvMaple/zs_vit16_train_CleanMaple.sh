...
CFG=vit_b16_c2_ep100_batch32_2ctx_9depth_cross_datasets_clean
SHOTS=16
...
#         DIR=/mnt/shared-storage-user/evoagi-share/xinwang/TAPT/output2025/evaluation/${TRAINER}/${CFG}_${SHOTS}shots/${DATASET}/seed${SEED}/${EPOCH}
#         if [ -d "$DIR" ]; then
